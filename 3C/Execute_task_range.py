...
def execute():
    task_ranges=[100,250,400,500,550]
    ...
    result_file = open('Experiment/task_range.docx', 'w')

    #在不同设备下，固定的任务数目在系统中的表现

    for i in range(0,len(task_ranges)):
        Task.task_range=task_ranges[i]
        joined_users = []
        ...
        result_file.write('Task range is %d\n'%Task.task_range)
