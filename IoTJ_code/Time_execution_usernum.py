...
def execute(iteration_time):
    ...
    result_file = open('Experiment/time_execution_usernum.docx', 'w')
    ...
    for iteration in range(0,iteration_time):
        ...
        for i in range(0, len(user_nums)):
            ...
            localexecution_overhead_gains[i][iteration]=(local_results[0]-cen_reciprocal_results[0])/local_results[0]*100
            ...
            directTocloud_overhead_gains[i][iteration]=(directToCloud_results[0]-cen_reciprocal_results[0])/ directToCloud_results[0]*100
            ...
            greedyreciprocal_overhead_gains[i][iteration]=(greedyreciprocal_results[0]-cen_reciprocal_results[0])/ greedyreciprocal_results[0]*100
            ...
            randomreciprocal_overhead_gains[i][iteration]=(ramdon_reciprocal_results[0]-cen_reciprocal_results[0])/ ramdon_reciprocal_results[0]*100
    ...
    for i in range(0,len(user_nums)):
        ...
        average_localexecution_energys[i] * 100))
