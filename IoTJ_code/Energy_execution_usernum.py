...
def execute(iteration_time):
    ...
    result_file = open('Experiment/energy_execution_usernum.docx', 'w')
    ...
    for iteration in range(0,iteration_time):
        ...
        for i in range(0, len(user_nums)):
            ...
            randomreciprocal_overhead_gains[i][iteration] = (ramdon_reciprocal_results[0] - cen_reciprocal_results[
                0]) / ramdon_reciprocal_results[0] * 100
